...
import { example2_WithCallbacks } from '@/game/engine';
example2_WithCallbacks();

// Ejemplo 3: Smart AI vs Random AI
import { example3_SmartAIvsRandomAI } from '@/game/engine';
example3_SmartAIvsRandomAI();

// Ejemplo 4: Simular 100 partidas
import { example4_MultipleGames } from '@/game/engine';
example4_MultipleGames(100);

// Ejemplo 5: Inspeccionar estado
import { example5_InspectGameState } from '@/game/engine';
example5_InspectGameState();

// Ejemplo 6: Replay de partida
import { example6_ReplayGame } from '@/game/engine';
example6_ReplayGame();
```
