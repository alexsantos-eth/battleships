...
export class GameService {
  ...
  private generateShip(
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
      ...
      const maxX =
        orientation === "horizontal" ? boardWidth - size : boardWidth - 1;
      const maxY =
        orientation === "vertical" ? boardHeight - size : boardHeight - 1;
      ...
      if (
        this.isValidShipPlacement(ship, existingShips, boardWidth, boardHeight)
      ) {
        return ship;
      }
    }
