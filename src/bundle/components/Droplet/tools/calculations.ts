...
export const DROPLET_START_Z = GAME_CONSTANTS.ANIMATIONS.DROPLET.START_Z;
export const DROPLET_END_Z = GAME_CONSTANTS.ANIMATIONS.DROPLET.END_Z;
export const DROPLET_START_OPACITY = GAME_CONSTANTS.ANIMATIONS.DROPLET.START_OPACITY;
export const DROPLET_END_OPACITY = GAME_CONSTANTS.ANIMATIONS.DROPLET.END_OPACITY;
