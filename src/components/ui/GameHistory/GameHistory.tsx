...
const GameHistoryItem: React.FC<GameHistoryItemProps> = ({
  ...
  return (
    <div
      className={`flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/10 ${className}`}
    >
...
export const GameHistory: React.FC<GameHistoryProps> = ({ className = "" }) => {
