...
import type { TestingInfoProps, ShotInfo, ShipCounts } from './TestingInfo.types';

export const TestingInfo: React.FC<TestingInfoProps> = ({ className = '' }) => {
  const {
    playerShips,
    enemyShips,
    playerShots,
  ...
  return (
    <div className={`fixed bottom-4 left-4 z-50 bg-black/70 backdrop-blur-md rounded-lg p-4 border border-white/20 max-w-sm ${className}`}>
